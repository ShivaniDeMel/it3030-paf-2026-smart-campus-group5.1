...
const Navbar = () => {
  ...
  const navigation = [
    ...
    { name: 'My Bookings', href: '/my-bookings', icon: QrCodeIcon },
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-4">
              {!loading && isAuthenticated ? (
                ...
                <div className="flex items-center space-x-4">
                  {/* Confirmed Bookings Notification */}
                  {confirmedBookingsCount > 0 && (
                    <Link
                      to="/my-bookings"
                      className="relative p-2 text-white/80 hover:text-white hover:bg-white/10 rounded-xl transition-all duration-300 transform hover:scale-105"
                      title={`You have ${confirmedBookingsCount} confirmed booking${confirmedBookingsCount !== 1 ? 's' : ''}`}
                    >
